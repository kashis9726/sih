    ...
    <div className="space-y-6">
      <div className="bg-white/80 backdrop-blur rounded-2xl p-6 shadow-elev-1 border border-white/50">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-extrabold text-gray-900">Knowledge Hub</h1>
            <p className="text-gray-600">Career stories, roadmaps, and tips. Connect with authors if needed.</p>
          </div>
          {((user?.role === 'alumni') || (user?.role === 'industry_hr')) && (
            <button
        ...
        <div className="mt-3 bg-blue-50 border border-blue-200 text-blue-900 rounded-lg p-3 text-sm">
          Long-form learnings and stories from the community. For quick updates, use the feed. To find a profile, use the directory.
        </div>
